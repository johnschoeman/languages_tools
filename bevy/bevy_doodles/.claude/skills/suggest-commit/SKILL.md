...
<this commit paragraph - briefly explain the what, wrap at 72 chars>
...
- `Add color change over time`
- `Add ability to change light source position`
- `Remove wireframe, add burgundy colors, and fix rotation smoothness`
...
```
Or copy the message: `cat commit-msg.txt | xclip -selection clipboard`"
